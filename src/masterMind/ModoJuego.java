...
/**
 * La clase ModoJuego posee los modos de juegos que se pueden cargar en la
 * aplicacion, asi como su configuracion
 * 
...
public enum ModoJuego {
	...
	/**
	 * Modo de juego FACIL 10 numero intentos 4 numero de casillas false repetir
	 * colores 8 numero de colores
	 */
	FACIL(10, 4, false, 8),
	/**
	 * Modo de juego MEDIO 15 numero de intentos 6 numero de casillas false repetir
	 * colores 8 numero de colores
	 */
	MEDIO(15, 6, false, 8),
	/**
	 * Modo de juego DIFICIL numero de intentos ilimitado? 8 numero de casillas true
	 * repetir colores 10 numero de colores
	 */
	 ...
	 *            posibilidad de repetir colores
	 * @param maxColores
	 *            numero maximo de colores
	 */
